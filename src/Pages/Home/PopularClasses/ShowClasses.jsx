...
const ShowClasses = ({ cls }) => {
    ...
    const handleAddToCart = cls => {
        ...
        if (user && user.email) {
            ...
            fetch('https://summer-school-camp-server-sage.vercel.app/carts', {
                method: 'POST',
                headers: {
        ...
        <div className="card card-compact w-96 bg-base-100 shadow-xl">
            ...
            <div className="card-body bg-orange-100">
                ...
                <div className="card-actions justify-end">
                    <button onClick={() => handleAddToCart(cls)} className="btn btn-outline border-0 border-b-4 mt-4 bg-orange-200">Select</button>
                </div>
            </div>
        </div>
    );
