...

    {
        ...
        children: [
            ...
            },
            {
                ...
                loader: ({ params }) => fetch(`https://summer-school-camp-server-psi.vercel.app/updateCoursesStatus/${params.id}`)
            },
            {
            ...
            },
            {
                ...
                loader: ({ params }) => fetch(`https://summer-school-camp-server-psi.vercel.app/instructorCourses/${params.id}`)
            },
            {
            ...
            },
            {
                ...
                loader: ({ params }) => fetch(`https://summer-school-camp-server-psi.vercel.app/approvedCourses/${params.id}`)
            },
            //Student Route
            {
                path: 'userHome',
